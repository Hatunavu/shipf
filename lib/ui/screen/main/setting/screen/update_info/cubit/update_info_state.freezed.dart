...
mixin _$UpdateInfoState {
  ...
  NotiConfig? get notiConfig => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      tonnage: freezed == tonnage
          ...
          : tonnage // ignore: cast_nullable_to_non_nullable
              as TonnageType?,
      notiConfig: freezed == notiConfig
          ? _value.notiConfig
          : notiConfig // ignore: cast_nullable_to_non_nullable
              as NotiConfig?,
    ) as $Val);
  }
}
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.notiConfig, notiConfig) ||
                other.notiConfig == notiConfig));
  }
